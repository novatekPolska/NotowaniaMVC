...
namespace NotowaniaMVC.Tests.NotowaniaMVC.Domain.Tests.Documents.Validators
{
    ...
    public class DocumentValidatorTests
    {
        ...
        {
            document = Document.Factory.Create("test", "test", "C:/Users/szklarek/Documents/Funkcje-logiczne w Excelu.pdf", 1, 1, null);
            var result = validator.Validate(document);
            Assert.AreEqual(result.IsValid, false);
        }
        ...
        {
            document = Document.Factory.Create("test", "test", "C:/Users/szklarek/Documents/Funkcje-logiczne w Excelu.pdf", 1, 1, new object());
            var result = validator.Validate(document);
        ...
        {
            document = Document.Factory.Create("test", "test", "d:/Users/szklarek/Documents/testtest.pdf", 1, 1, new object());
            var result = validator.Validate(document);
            Assert.AreEqual(result.IsValid, false);
        }
